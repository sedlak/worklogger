...
public class Worklog {
	...
	public Worklog(String issueKey, String issueSummary, String dateStarted, String comment, int timeSpentSeconds) {
	...
	public String toString() {
		return "Worklog{" + "issueKey='" + issueKey + '\'' + "issueSummary='" + issueSummary + '\'' + ", dateStarted='" + dateStarted + '\'' + ", comment='" + comment + '\''
